...
def export_excel(
    ...
    with pd.ExcelWriter(output_path, engine="openpyxl") as writer:
        ...
        if not matrix_df.empty:
            ...
            _enrich_extra = [c for c in ("contact_phone", "phone_type", "website_mobile", "website_email", "website_whatsapp", "website_instagram", "legal_name", "google_maps_link", "data_source") if c in matrix_df.columns]
            ...
            _enrich_widths = {"contact_phone": 18, "phone_type": 14, "website_mobile": 18, "website_email": 26, "website_whatsapp": 18, "website_instagram": 24, "legal_name": 28, "google_maps_link": 14, "data_source": 18}
